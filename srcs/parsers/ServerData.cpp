...
ServerData::~ServerData() {
    ...
    _port_redirection = 0;
    _location_data_vector = std::vector<ServerLocation>();
}
...
void ServerData::addToLocationVector(ServerLocation location_data) {
    _location_data_vector.push_back(location_data);
}
